...
const computeStarsPosition = () => (Math.floor(window.scrollY * 0.15) * -1)
const computeCloudPositionX = () => (Math.floor(window.scrollY * 0.05)) + CLOUD_STARTING_POSITION
const computeCloudPositionY = () => (Math.floor(window.scrollY * 0.01))
const computeCloudOpacity = () => 100 / (window.scrollY * 0.1)
